...
- Passionate about software development & clean architecture  
...
**Database:**  
`SQLite` `MongoDB` `MySQL` `Firebase Realtime/Firestore`  

**Tools:**  
`Git` `Github` `Postman` `Figma` `VS Code` `Android Studio`  

**Soft Skills:**  
`Teamwork` `Communication` `Problem-solving` `Self-learning`
